 ...
 */
public class X12ParserResponseExtStatusResponse {
	...
	public X12ParserResponseExtStatusResponse() {
		
	}
	 
	public X12ParserResponseExtStatusResponse(String status, String timestamp, String message, Edi271 results) {
		super();
		this.status = status;
